...
if (isset($_POST['login'])) {
    ...
    $stmt = mysqli_prepare($con, "SELECT user_name, pass FROM sign_up WHERE user_name = ? LIMIT 1");
...
if (isset($_POST['submit'])) {
    ...
    if ($password == $confirmpassword) {
        // Use prepared statement to prevent SQL injection
        $stmt = mysqli_prepare($con, "INSERT INTO sign_up (user_name, email, pass) VALUES (?, ?, ?)");
